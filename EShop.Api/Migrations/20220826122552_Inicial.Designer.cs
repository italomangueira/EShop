...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Api.Entities.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Api.Entities.CarrinhoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Api.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Api.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Api.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Api.Entities.Carrinho", b =>
                {
                    b.HasOne("EShop.Api.Entities.Usuario", null)
                        .WithOne("Carrinho")
                        .HasForeignKey("EShop.Api.Entities.Carrinho", "UsuarioId")
            ...
            modelBuilder.Entity("EShop.Api.Entities.CarrinhoItem", b =>
                {
                    b.HasOne("EShop.Api.Entities.Carrinho", "Carrinho")
                        .WithMany("Itens")
                        .HasForeignKey("CarrinhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EShop.Api.Entities.Produto", "Produto")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("EShop.Api.Entities.Produto", b =>
                {
                    b.HasOne("EShop.Api.Entities.Categoria", "Categoria")
                        .WithMany("Produtos")
